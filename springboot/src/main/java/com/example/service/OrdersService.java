...
public class OrdersService {
    ...
    public void add(Orders orders) {
        ...
        Article article = articleMapper.selectById(orders.getArticleId());
        Double price = article.getPrice();
        if (MemberEnum.YES.info.equals(user.getMember())) {
            // 享受折扣价
            price = article.getPrice() * article.getDiscount();
        }
        // 判断余额够不够
        ...
        // 扣除用于余额
        user.setScore((int)(user.getScore() - price));
